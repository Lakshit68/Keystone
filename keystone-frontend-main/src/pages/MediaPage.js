  ...
  return (
    <div className="flex flex-col w-full gap-6 mb-8 md:mb-16 mt-16">
      <HeroSection
        ...
        subtitle="Media"
        backgroundVideo={
          // "https://res.cloudinary.com/dopvfhjhs/video/upload/v1748884469/media_eaqi8l.mp4"
          videofour
        }
      />
      {mediaData.map((item, index) => (
        <InfoCard
          ...
          index={index}
          imageSrc={
            // "https://res.cloudinary.com/dopvfhjhs/image/upload/v1748884296/media_di61gv.png"
            item.image
          }
